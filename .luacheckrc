...
-- Mostly shamelessly copied from WeakAuras. Thank you!
globals = {
	"_G",
	"bit",
	"lfs",
   ...
   -- Namespaces
	...
	"C_Spell.GetMaxSpellStartRecoveryOffset",
	"GetMaxTalentTier",
	"GetMeleeHaste",
