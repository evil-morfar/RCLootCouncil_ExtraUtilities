...
L["Other"] = true
L["Pawn column was disabled as Pawn isn't installed."] = true
L["Pawn specific options"] = true
L["RCLootCouncil Columns"] = true
L["RCScore column was disabled as no damage meter is installed."] = true
L["Scales"] = true
...
L["opt_traits_desc"] = "Enables a column showing the level of the candidate's Heart of Azeroth."
